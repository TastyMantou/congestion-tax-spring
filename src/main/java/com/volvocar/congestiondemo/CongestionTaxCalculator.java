package com.volvocar.congestiondemo;
...
import com.volvocar.congestiondemo.entity.Vehicle;
...
public class CongestionTaxCalculator {
    ...
    public int GetTollFee(Date date, Vehicle vehicle)
    {
        ...
        else if (hour >= 8 && minute >= 30 && minute <= 59) return 8;    //new logic
        else if (hour >= 9 && hour <= 14 && minute <= 59) return 8;   //new logic
